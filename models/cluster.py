...
class PCM(nn.Module):
    """
    Initialize the patch-level compression module (FCM).
    Args:
        sample_ratio (float): The ratio of tokens to be sampled.
        embed_dim (int): The input dimension of the token embeddings.
        dim_out (int): The output dimension of the token embeddings.
        k (int): The number of top tokens to be selected. Defaults to 5.
    """
...
class Att_PCM(nn.Module):
    ...
    Video frame and patch aggregation module supported by the text.
    Args:
    """
